...
*
*
* @example // You can use the function by providing the url of the API endpoint, custom headers in a dictionary form and offset and limit as integers for pagination.
const headers1 = {'Authorization': 'Token YOUR_API_KEY'};
const data1 = await apiBaseFetch('https://api.example.com/items', headers, 0, 25);
*
*
* @example // You can also use this function with an argument, like offset and limit as default. and then call it without those argument.
