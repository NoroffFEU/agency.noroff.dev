...
export const dummyApiRegisterUser = "https://dummyjson.com/users/add"// It will simulate a POST request and will return the new created user with a new id
export const dummyApiLogin = "https://dummyjson.com/auth/login"; // user Login
