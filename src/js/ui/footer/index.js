    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 row-cols-lg-4 justify-content-evenly">
      ...
      <div class="col" data-footer-col>
        ...
        <div class="d-flex flex-column gap-1">
          <a href="tel:38000000" class="nav-link text-white"><img src="/images/icons/phone.svg" class="footerIcon"/> 38000000</a>
          <a href="mailto:utdanning@noroff.no" class="nav-link text-white"><img src="/images/icons/mail.svg" class="footerIcon"/> utdanning@noroff.no</a>
        </div>
      </div>
      <div class="col" data-footer-col>
