  ...
  footerElement.innerHTML = `<div class="container container-fluid text-white">
                                <div class="row p-4 d-flex">
                                  ...
                                  <div class="col p-4">
                                    <h4>Resources</h4>
                                    <ul class="p-0">
                                      <li class="list-group-item"><a href="/privacy_policy.html" class="nav-link ">Privacy Policy</a></li>
                                      <li class="list-group-item"><a href="/terms_of_use.html" class="nav-link">Terms of use</a></li>
                                    </ul>
                                  </div>
                                </div>
                            </div>`;
