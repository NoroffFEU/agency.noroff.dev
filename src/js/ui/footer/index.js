export const footer = () => {
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 row-cols-lg-4 justify-content-evenly">
      ...
      <div class="col" data-footer-col>
        ...
        <ul class="p-0 d-flex flex-column gap-1">
       <li class="list-group-item"><a href="#" class="nav-link text-white" target="_blanc">Customer Service</a></li>
       <li class="list-group-item"><a href="#" class="nav-link text-white" target="_blanc">Terms of use</a></li>
       <li class="list-group-item"><a href="#" class="nav-link text-white" target="_blanc">Ad policies</a></li>
       </ul>
      </div>
    </div>
  </div>
