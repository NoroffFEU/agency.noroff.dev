...
export const checkState = () => {
  ...
  if (role == 'user') {
    ...
    <li class="nav-item">
      <a class="btn btn-outline-light text-white fw-semibold" href="#" id="signOut navItems">Log out</a>
    </li>
  </ul>`);
  }
  ...
  if (role == 'admin') {
    ...
    <li class="nav-item">
      <a class="nav-link text-white fw-semibold" aria-current="page" href="#" id="navItems">Profile</a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-white fw-semibold" href="/pages/listings/index.html" id="navItems">Listings</a>
    </li>
    <li class="nav-item">
      <a class="btn btn-outline-light text-white fw-semibold" href="#" id="logOutUser navItems">Log out</a>
    </li>
  </ul>`);
  }
