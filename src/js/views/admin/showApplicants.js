  ...
  for (let i = 0; i < applicantData.length; i++) {
    ...
    applicant = `
      <tr>
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content rounded-0 border-0">
                    ...
                    <div class="modal-body px-4 pt-0">
                      ...
                      <p>${applicantsName}</p>
                      <a href="${applicationLink}" class="list-group-item fw-normal fst-italic"><img src="/src/assets/icons/linkApplicant.svg" alt="Link icon" class="footerIcon me-3" /> ${applicationLink}</a>
                      <a href="#" class="list-group-item fw-normal mt-2"><img src="/src/assets/icons/download.svg" alt="File icon" class="footerIcon me-3" download/> ${applicationFile}</a>
                    </div>
        ...
        <td>
            <button class="btn btn-sm applicant-delete-btn"><img src="/src/assets/icons/delete-black.svg" alt="Delete button" class="footerIcon" /></button>
        </td>
      </tr>
      `;
