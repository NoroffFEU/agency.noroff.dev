    ...
    listings.forEach((listing, number) => {
       ...
       <div class="col-sm-6">
         <div class="row p-2 px-3 g-3 bg-theme-light m-0">
           <div class="m-0 px-0 col-md-3 d-flex flex-column justify-content-center">
             <img src="../../images/logoipsum-287.svg" class="img-fluid rounded-start" alt="..." />
           </div>
           <div class="m-0 col-md-9 d-flex flex-column gap-2 align-items-baseline">
             ...
             <div class="d-flex align-items-end justify-content-between w-100" style="font-size: .75rem">
