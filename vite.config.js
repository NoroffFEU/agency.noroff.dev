  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        faq: path.resolve(__dirname, 'pages/footer/faq.html'),
        aboutNoroffJobs: path.resolve(__dirname, 'pages/footer/aboutNoroffJobs.html'),
        privacy: path.resolve(__dirname, 'pages/footer/privacypolicy.html'),
        terms: path.resolve(__dirname, 'pages/footer/termsofuse.html'),
